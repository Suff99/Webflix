        ...
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <button name="add_category" data-toggle="modal" data-target="#category_modal"
        ...
        <div class="col-sm-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button name="list_categories" data-toggle="modal" data-target="#categories_modal"
                            class="btn btn-primary">Go
                    </button>
                </div>
...
<!-- Category List Modal -->
<div class="modal fade" id="categories_modal" tabindex="-1" role="dialog" aria-labelledby="category_modalTitle"
     aria-hidden="true">
...
<!-- Category Add Modal -->
<div class="modal fade" id="category_modal" tabindex="-1" role="dialog" aria-labelledby="category_modalTitle"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="container">
                    <br>
                    <form name="category_form" id="category_form" action="includes/category.php" method="post"
                          class="alert-dismissible fade show" role="alert">
                        <div class="form-group">
                            <label for="category">Category Name</label>
                            <input id="category" name="category" placeholder="Action" type="text" required="required"
                                   class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="description">Category Description</label>
                            <textarea id="description" name="description" cols="40" rows="2"
                                      aria-describedby="descriptionHelpBlock" class="form-control"></textarea>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" type="submit" form="form" name="btn_category"
                        id="btn_category">Add
                </button>
            </div>
        </div>
