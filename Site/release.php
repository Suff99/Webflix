                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="rating">
                            ...
                            <label for="rating_5">☆</label> <input type="radio" name="rating" value="4" id="rating_4"
                                                                   required="required">
                            <label for="rating_4">☆</label> <input type="radio" name="rating" value="3" id="rating_3"
                                                                   required="required">
                            <label for="rating_3">☆</label> <input type="radio" name="rating" value="2" id="rating_2"
                                                                   required="required">
                            <label for="rating_2">☆</label> <input type="radio" name="rating" value="1" id="rating_1"
                                                                   required="required">
