        ...
        <div class="jumbotron" style="width: 80%">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col">
                        <img src="<?php echo json_decode($movie['images'])->backdrop; ?>" class="card-img"
                    ...
                    <div class="col">
                        ...
                        <div class="yt_container"><iframe class="responsive-iframe" width="560" height="315"
                ...
                <form action="includes/comment.php?release_id=<?php echo $id; ?>" method="post"
                    ...
                    <div class="form-group row">
                        <div class="offset-4 col-8">
                            <button name="user_id" type="submit" class="btn btn-primary"
                                value="<?php echo $_POST['user_id'] ?>">Submit</button>
                        </div>
                    </div>
                </form>
